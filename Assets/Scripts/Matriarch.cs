...
public class Matriarch : MonoBehaviour
{
    ...
    void OnMouseEnter()
    {
        if (PlayerPrefs.GetInt("Clicked") != 1)
        {
            ...
            {
                textbox.text = PlayerPrefs.GetString("P" + PlayerPrefs.GetInt("MatriarchP") + "-Name") + " HP: " + PlayerPrefs.GetInt("P" + PlayerPrefs.GetInt("MatriarchP") + "-CHP") +
                "/" + PlayerPrefs.GetInt("P" + PlayerPrefs.GetInt("MatriarchP") + "-HP") + "    SP: " + PlayerPrefs.GetInt("P" + PlayerPrefs.GetInt("MatriarchP") + "-CSP") + "/"
                + PlayerPrefs.GetInt("P" + PlayerPrefs.GetInt("MatriarchP") + "-SP") + "\n" + "Guard: " + PlayerPrefs.GetInt("P1-CG") + "/" + PlayerPrefs.GetInt("P1-Guard");
                if (PlayerPrefs.GetInt("P" + PlayerPrefs.GetInt("MatriarchP") + "-TurnTaken") == 0 && PlayerPrefs.GetInt("P" + PlayerPrefs.GetInt("MatriarchP") + "-CHP") > 0)
                {
                    //this moves cards
                    Vector3 temp = new Vector3(-300 * 2.893986f, -154 * 2.893986f, -1 * 2.893986f);
                    skillcard_A.transform.position = temp;
                    Damage_A.text = PlayerPrefs.GetInt("P" + PlayerPrefs.GetInt("MatriarchP") + "-Attack").ToString();
                    ...
                    Damage_1.text = PlayerPrefs.GetInt("P" + PlayerPrefs.GetInt("MatriarchP") + "-S1-Damage").ToString();
                    Cost_1.text = PlayerPrefs.GetInt("P" + PlayerPrefs.GetInt("MatriarchP") + "-S1-Cost").ToString();
                    SName_1.text = PlayerPrefs.GetString("P" + PlayerPrefs.GetInt("MatriarchP") + "-Skill-1");
                    ...
                    int Loc = PlayerPrefs.GetInt("P" + PlayerPrefs.GetInt("MatriarchP") + "-Loc");
                    if (PlayerPrefs.GetInt("P" + PlayerPrefs.GetInt("MatriarchP") + "-CanMove") == 1)
                    {
                            ...
                            case 1:
                                {
                                    ...
                                    if (PlayerPrefs.GetInt("Block-" + offset + "-Moveable") == 1)
                                    {
                                        ...
                                        PlayerPrefs.SetInt("P" + PlayerPrefs.GetInt("MatriarchP") + "-Block-" + offset + "-Moveable", 1);
                                    }
                                    offset = Loc + 4;
                                    if (PlayerPrefs.GetInt("Block-" + offset + "-Moveable") == 1)
                                    {
                ...
                if (PlayerPrefs.GetInt("MatriarchBig") == 0)
                {
                    PlayerPrefs.SetInt("MatriarchBig", 1);
    ...
    public void OnMouseDown()
    {
        if (PlayerPrefs.GetInt("P" + PlayerPrefs.GetInt("MatriarchP") + "-TurnTaken") == 0 && PlayerPrefs.GetInt("P" + PlayerPrefs.GetInt("MatriarchP") + "-CHP") > 0)
        {
            ...
            PlayerPrefs.SetInt("P" + PlayerPrefs.GetInt("MatriarchP") + "-Clicked", 1);
    ...
    public void OnMouseExit()
    {
        ...
        if (PlayerPrefs.GetInt("Clicked") != 1)
        {
            for (int i = 0; i <= 25; i++)
            {
                PlayerPrefs.SetInt("P" + PlayerPrefs.GetInt("MatriarchP") + "-Block-" + i + "-Moveable", 0);
            }
            //makes blocks clickable over him
            if (PlayerPrefs.GetInt("MatriarchBig") == 1)
            {
                transform.localScale = transform.localScale / 1.1f;
                PlayerPrefs.SetInt("MatriarchBig", 0);
            }
