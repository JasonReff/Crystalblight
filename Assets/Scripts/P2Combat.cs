...
public class P2Combat : MonoBehaviour
{
    ...
    public void OnMouseDown()
    {
        ...
        {
            PlayerPrefs.SetInt("PNumber", 2);
        }
        else if (PlayerPrefs.GetString("ActiveSkill") != "None" && PlayerPrefs.GetString(PlayerPrefs.GetString("ActiveSkill") + "-Targeting") == "FriendlyTargetOther" && PlayerPrefs.GetInt("P2-Clicked") == 0)
        {
            PlayerPrefs.SetInt("PNumber", 2);
        }
        else
    ...
    public void OnMouseExit()
    {
        ...
        if (PlayerPrefs.GetInt("Clicked") != 1)
        {
            for (int i = 0; i <= 25; i++)
            {
                PlayerPrefs.SetInt("P2-Block-" + i + "-Moveable", 0);
            }
            //makes blocks clickable over him
            if (PlayerPrefs.GetInt("P2Big") == 1)
            {
                transform.localScale = transform.localScale / 1.1f;
                PlayerPrefs.SetInt("P2Big", 0);
            }
