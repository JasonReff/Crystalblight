...
public class Shocktoad : MonoBehaviour
{
    public Text textbox;
    ...
    void Start()
    {
        ...
        {
            PlayerPrefs.SetInt("E1-CHP", 25);
            PlayerPrefs.SetInt("E1-HP", 25);
            PlayerPrefs.SetInt("E1-CG", 20);
            PlayerPrefs.SetInt("E1-Guard", 20);
    ...
    void SetLoc()
    {
        ...
        GameObject Vill = GameObject.Find("Shocktoad");
    ...
    void OnMouseEnter()
    {
        textbox.text = "Shocktoad" + " Guard: " + PlayerPrefs.GetInt("E1-CG") + "/" + "20" + " HP: " + PlayerPrefs.GetInt("E1-CHP")
            + "/" + "180" + "\n" + "Intent: " + PlayerPrefs.GetString("E1-CAtt") + " 10 Damage";
    ...
    public void Attack()
    {
        ...
        if (PlayerPrefs.GetInt("P" + PlayerPrefs.GetInt("E1-AttP") + "-Guarding") == 1)
        {
            PCG = PCG - 4;
        }
        else
